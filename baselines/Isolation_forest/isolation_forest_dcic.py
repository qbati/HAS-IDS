...
RUN_NAME = "baseline_iforest_dcic"
...
# Use 'label' (which is in DBcic2017_train.csv)
...
try:
    ...
    # --- Define the order for DCIC2017 ---
    category_order = [
        "Normal", "Botnet", "DDoS", "DoS GoldenEye", "DoS Hulk", 
        "DoS Slowhttptest", "DoS Slowloris", "FTP-Patator", "Heartbleed", 
        "Infiltration", "Infiltration - Portscan", "Portscan", "SSH-Patator", 
...
metrics = {
    "model": "IsolationForest", "dataset": "DCIC2017", "seed": SEED,
