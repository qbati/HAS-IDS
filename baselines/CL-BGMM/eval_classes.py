...
# ========== FILE LOCATIONS ==========
binary_csv_path = r"dir_cic_v2\prediction_results.csv"           # Contains 'binary_label', 'binary_pred'
multiclass_csv_path = r"..\Datasets\DCIC2017\DMcic2017_test.csv"     # Contains 'attack_cat' column

print("Loading binary predictions and multiclass labels...")
